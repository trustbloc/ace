...
LICENSE_LOC="$PWD/scripts/license_header.txt"
...
GENERATE_MODELS_COMMAND="generate model --spec=$SPEC_LOC -r $LICENSE_LOC"
GENERATE_CLIENT_COMMAND="generate client -f $SPEC_LOC -r $LICENSE_LOC"
