...
func (o *Operation) GetConfig(w http.ResponseWriter, _ *http.Request) {
	...
	fmt.Printf("getConfig did: %s", *cc.Did)
...
func (o *Operation) createConfig() error { //nolint: funlen
	// create did
	...
	fmt.Printf("didId %s, resDid %s, assertion %d, auth %d",
		*comparatorConfig.Did, didID, len(didDoc.AssertionMethod), len(didDoc.Authentication))
